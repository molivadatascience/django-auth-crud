...
class TaskForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            #'fecha_entrega_propuesta':forms.DateInput(attrs={'class': 'form-control'}),
            #'fecha_entrega_productos':forms.DateInput(attrs={'class': 'form-control'}),
            'solicitud_muestra': forms.CheckboxInput(attrs={'class': 'form-check-input m-auto'}),
            'description': forms.Textarea(attrs={'class': 'form-control','placeholder': 'Write a description'}),
            #'fecha_cotizacion':forms.DateInput(attrs={'class': 'form-control'}),
